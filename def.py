...
def create_bitfolder():
	print(os.getcwd())
	if not os.path.exists("32_bit"): # CHECKS IF THE FOLDER WITH THE GIVEN NAME EXISTS.
		os.makedirs("32_bit") # CREATES THE FOLDER WITH THE GIVEN NAME.
	if not os.path.exists("64_bit"): # CHECKS IF THE FOLDER WITH THE GIVEN NAME EXISTS.
		os.makedirs("64_bit") # CREATES THE FOLDER WITH THE GIVEN NAME.

def move_file():
	today = datetime.now() #ASSIGNING THE DATE AND TIME TO THE VARIABLE today
	
	#os.rename("/home/sncsag/Documents/Defender_Updates/06-01-21/MS Defender Updates for Windows 10 and Windows 8.1 (32bit).exe", "/home/sncsag/Documents/Defender_Updates/06-01-21/32_bit/MS Defender Updates for Windows 10 and Windows 8.1 (32bit).exe")

	#os.rename("/home/sncsag/Documents/Defender_Updates/06-01-21/MS Defender Updates for Windows 10 and Windows 8.1 (64bit).exe", "/home/sncsag/Documents/Defender_Updates/06-01-21/64_bit/MS Defender Updates for Windows 10 and Windows 8.1 (64bit).exe")

	#os.rename("/home/sncsag/Documents/Defender_Updates/06-01-21/Network Real-time Inspection Definition Updates (32bit).exe", "/home/sncsag/Documents/Defender_Updates/06-01-21/32_bit/Network Real-time Inspection Definition Updates (32bit).exe")

	os.rename("/home/sncsag/Documents/Defender_Updates/06-01-21/Network Real-time Inspection Definition Updates (64bit).exe", "/home/sncsag/Documents/Defender_Updates/06-01-21/64_bit/Network Real-time Inspection Definition Updates (64bit).exe")
	
	#os.rename("/home/sncsag/Documents/Defender_Updates/” + today.strftime('%d-%m-%y') + ”/Network Real-time Inspection Definition Updates (64bit).exe", "/home/sncsag/Documents/Defender_Updates/06-01-21/64_bit/Network Real-time Inspection Definition Updates (64bit).exe")
